module Erlang.Io(onload, erlps__put_chars__1,
                 erlps__put_chars__2, erlps__nl__0, erlps__nl__1,
                 erlps__get_chars__2, erlps__get_chars__3, erlps__get_line__1,
                 erlps__get_line__2, erlps__get_password__0,
                 erlps__get_password__1, erlps__setopts__1, erlps__setopts__2,
                 erlps__getopts__0, erlps__getopts__1, erlps__write__1,
                 erlps__write__2, erlps__read__1, erlps__read__2,
                 erlps__read__3, erlps__read__4, erlps__columns__0,
                 erlps__columns__1, erlps__rows__0, erlps__rows__1,
                 erlps__fwrite__1, erlps__fwrite__2, erlps__fwrite__3,
                 erlps__fread__2, erlps__fread__3, erlps__format__1,
                 erlps__format__2, erlps__format__3, erlps__request__1,
                 erlps__request__2, erlps__requests__1, erlps__requests__2,
                 erlps__printable_range__0) where
{-
...
onload :: ErlangFun
onload _ = (erlps__elo__0 [])

erlps__elo__0 :: ErlangFun
erlps__elo__0 [] =
  let arg_0 = (make_string "XDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD\n")
  in (erlps__format__1 [arg_0])
erlps__elo__0 args =
