...
erlps__to_tuple__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_tuple__1) args
  ...
  in
    case case_3 of
      (ErlangTuple [(ErlangAtom "error"), reason_6]) ->
        ...
        in let matchExpr_11 = BIF.erlang__tuple_to_list__1 [arg_7]
        in
          case matchExpr_11 of
            (ErlangCons _name_9 args_10) ->
              let
                matchExpr_28 =
                  EXC.tryCatch
                    (\ _ -> BIF.erlang__error__1 [ErlangAtom "get_stacktrace"])
                    (\ ex_14 ->
                       case ex_14 of
                         (ErlangTuple [(ErlangAtom "throw"), payload_16, _]) ->
                           payload_16
                         (ErlangTuple [(ErlangAtom "error"), payload_17,
                                       stack_18]) ->
                ...
                case matchExpr_28 of
                  (ErlangTuple [(ErlangAtom "EXIT"),
                                (ErlangTuple [(ErlangAtom "get_stacktrace"),
                                              (ErlangCons _current_26 mfas_27)])]) ->
                    let    arg_30 = erlps__conv_reason__2 [func_2, reason_6]
                    in let
                      head_34 =
                        ErlangTuple
                    ...
                    in
                      BIF.erlang__raise__3
                        [ErlangAtom "error", arg_30, ErlangCons head_34 mfas_27]
                  _ -> EXC.badmatch matchExpr_28
            _ -> EXC.badmatch matchExpr_11
      other_41 -> other_41
erlps__o_request__3 [arg_42, arg_43, arg_44] =
  EXC.function_clause unit
erlps__o_request__3 args =
  EXC.badarity (ErlangFun 3 erlps__o_request__3) args
...
erlps__printable_range__0 args =
  EXC.badarity (ErlangFun 0 erlps__printable_range__0) args
...
erlps__put_chars__1 args =
  EXC.badarity (ErlangFun 1 erlps__put_chars__1) args
...
erlps__columns__0 args =
  EXC.badarity (ErlangFun 0 erlps__columns__0) args

erlps__columns__1 :: ErlangFun
erlps__columns__1 [io_0] =
  let   
    arg_3 =
      ErlangTuple [ErlangAtom "get_geometry", ErlangAtom "columns"]
  in let case_1 = erlps__request__2 [io_0, arg_3]
  in
    case case_1 of
      n_6 | (isEInt n_6) && (weakGt n_6 (toErl 0)) ->
...
erlps__columns__1 args =
  EXC.badarity (ErlangFun 1 erlps__columns__1) args
...
erlps__rows__0 args =
  EXC.badarity (ErlangFun 0 erlps__rows__0) args

erlps__rows__1 :: ErlangFun
erlps__rows__1 [io_0] =
  let   
    arg_3 =
      ErlangTuple [ErlangAtom "get_geometry", ErlangAtom "rows"]
  in let case_1 = erlps__request__2 [io_0, arg_3]
  in
    case case_1 of
      n_6 | (isEInt n_6) && (weakGt n_6 (toErl 0)) ->
...
erlps__rows__1 args =
  EXC.badarity (ErlangFun 1 erlps__rows__1) args
...
erlps__get_chars__2 args =
  EXC.badarity (ErlangFun 2 erlps__get_chars__2) args

erlps__get_chars__3 :: ErlangFun
erlps__get_chars__3 [io_0, prompt_1, n_2]
  | (isEInt n_2) && (weakGeq n_2 (toErl 0)) =
  let
    arg_4 =
      ErlangTuple
        [ErlangAtom "get_chars", ErlangAtom "unicode", prompt_1, n_2]
  in erlps__request__2 [io_0, arg_4]
erlps__get_chars__3 [arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__get_chars__3 args =
  EXC.badarity (ErlangFun 3 erlps__get_chars__3) args
...
erlps__get_line__1 args =
  EXC.badarity (ErlangFun 1 erlps__get_line__1) args
...
erlps__getopts__0 args =
  EXC.badarity (ErlangFun 0 erlps__getopts__0) args
...
erlps__getopts__1 args =
  EXC.badarity (ErlangFun 1 erlps__getopts__1) args
...
erlps__setopts__1 args =
  EXC.badarity (ErlangFun 1 erlps__setopts__1) args
...
erlps__setopts__2 args =
  EXC.badarity (ErlangFun 2 erlps__setopts__2) args
...
erlps__write__1 args =
  EXC.badarity (ErlangFun 1 erlps__write__1) args
...
erlps__write__2 args =
  EXC.badarity (ErlangFun 2 erlps__write__2) args
...
erlps__read__1 args =
  EXC.badarity (ErlangFun 1 erlps__read__1) args
...
erlps__read__2 [io_0, prompt_1] =
  ...
  in let
    arg_4 =
      ErlangTuple
        [ErlangAtom "get_until", ErlangAtom "unicode", prompt_1,
         ErlangAtom "erl_scan", ErlangAtom "tokens",
  ...
  in
    case case_2 of
      (ErlangTuple [(ErlangAtom "ok"), toks_13, _endline_14]) ->
        let match_final_15_16 = toErl 2
        in
          case match_final_15_16 of
            (ErlangInt num_17) | (ErlangInt num_17) == (toErl 1) ->
              match_final_15_16
            _ -> EXC.badmatch match_final_15_16
      (ErlangTuple [(ErlangAtom "error"), e_19, _endline_20]) ->
        ErlangTuple [ErlangAtom "error", e_19]
      (ErlangTuple [(ErlangAtom "eof"), _endline_23]) ->
        ErlangAtom "eof"
      other_24 -> other_24
erlps__read__2 [arg_25, arg_26] = EXC.function_clause unit
erlps__read__2 args =
  EXC.badarity (ErlangFun 2 erlps__read__2) args
...
erlps__read__3 args =
  EXC.badarity (ErlangFun 3 erlps__read__3) args
  ...
  in
    case case_9 of
      (ErlangTuple [(ErlangAtom "ok"), toks_18, endlocation_19]) ->
        let match_final_20_21 = toErl 2
        in
          case match_final_20_21 of
            (ErlangInt num_22) | (ErlangInt num_22) == (toErl 1) ->
              match_final_20_21
            _ -> EXC.badmatch match_final_20_21
      error_26@(ErlangTuple [(ErlangAtom "error"), _e_24,
                             _endlocation_25]) ->
        error_26
      eof_28@(ErlangTuple [(ErlangAtom "eof"), _endlocation_27]) ->
        eof_28
      other_29 -> other_29
erlps__read__4 [arg_30, arg_31, arg_32, arg_33] =
  EXC.function_clause unit
erlps__read__4 args =
  EXC.badarity (ErlangFun 4 erlps__read__4) args

erlps__conv_reason__2 :: ErlangFun
erlps__conv_reason__2 [_, (ErlangAtom "arguments")] =
  ErlangAtom "badarg"
erlps__conv_reason__2 [_, (ErlangAtom "terminated")] =
  ErlangAtom "terminated"
erlps__conv_reason__2 [_,
                       (ErlangTuple [(ErlangAtom "no_translation"), _, _])]
  =
...
erlps__conv_reason__2 args =
  EXC.badarity (ErlangFun 2 erlps__conv_reason__2) args
...
erlps__fwrite__1 args =
  EXC.badarity (ErlangFun 1 erlps__fwrite__1) args
...
erlps__fwrite__2 args =
  EXC.badarity (ErlangFun 2 erlps__fwrite__2) args

erlps__fwrite__3 :: ErlangFun
erlps__fwrite__3 [io_0, format_1, args_2] =
  erlps__format__3 [io_0, format_1, args_2]
erlps__fwrite__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
erlps__fwrite__3 args =
  EXC.badarity (ErlangFun 3 erlps__fwrite__3) args
...
erlps__fread__2 args =
  EXC.badarity (ErlangFun 2 erlps__fread__2) args

erlps__fread__3 :: ErlangFun
erlps__fread__3 [io_0, prompt_1, format_2] =
  let arg_4 = ErlangTuple [ErlangAtom "fread", prompt_1, format_2]
  in erlps__request__2 [io_0, arg_4]
erlps__fread__3 [arg_8, arg_9, arg_10] = EXC.function_clause unit
erlps__fread__3 args =
  EXC.badarity (ErlangFun 3 erlps__fread__3) args
...
erlps__format__3 args =
  EXC.badarity (ErlangFun 3 erlps__format__3) args
...
erlps__request__1 args =
  EXC.badarity (ErlangFun 1 erlps__request__1) args
...
erlps__execute_request__2 [pid_0,
  ...
  in let
    arg_6 =
      ErlangTuple
        [ErlangAtom "io_request", tup_el_8, mref_3, converted_2]
  in let
    case_4 =
      BIF.do_remote_fun_call "Erlang.Ioserver" "erlps__request__2"
        [pid_0, arg_6]
  in
    case case_4 of
      (ErlangTuple [(ErlangAtom "io_reply"), mref_11,
                    reply_12]) | mref_11 == mref_3 ->
...
erlps__execute_request__2 args =
  EXC.badarity (ErlangFun 2 erlps__execute_request__2) args
...
erlps__requests__1 args =
  EXC.badarity (ErlangFun 1 erlps__requests__1) args
  ...
  in
    case matchExpr_6 of
      (ErlangTuple [convert_4, converted_5]) ->
        let   
          tup_el_10 = ErlangTuple [ErlangAtom "requests", converted_5]
...
erlps__io_requests__2 args =
  EXC.badarity (ErlangFun 2 erlps__io_requests__2) args

erlps__io_requests__4 :: ErlangFun
erlps__io_requests__4 [pid_0,
                       (ErlangCons (ErlangTuple [(ErlangAtom "requests"),
                                                 rs1_1]) rs_2),
                       cont_3, tail_4]
  =
  erlps__io_requests__4
...
erlps__io_requests__4 [pid_0, (ErlangCons r_1 (ErlangEmptyList)),
  ...
  =
  let matchExpr_7 = erlps__io_request__2 [pid_0, r_1]
  in
    case matchExpr_7 of
...
erlps__io_requests__4 [pid_0, (ErlangCons r_1 rs_2), cont_3,
                       tail_4]
  =
  let matchExpr_8 = erlps__io_request__2 [pid_0, r_1]
  in
    case matchExpr_8 of
...
erlps__io_requests__4 args =
  EXC.badarity (ErlangFun 4 erlps__io_requests__4) args
      ...
      in
        case case_6 of
          ...
          (ErlangCons op_12 (ErlangCons _enc_13 t_14)) ->
            let req_18 = BIF.erlang__list_to_tuple__1 [ErlangCons op_12 t_14]
...
erlps__bc_req__3 args =
  EXC.badarity (ErlangFun 3 erlps__bc_req__3) args
...
erlps__io_request__2 [pid_0,
  ...
  let
    arg_3 =
      ErlangTuple
        [ErlangAtom "put_chars", ErlangAtom "unicode",
         ErlangAtom "io_lib", ErlangAtom "write",
...
erlps__io_request__2 [pid_0,
  ...
  let
    arg_4 =
      ErlangTuple
        [ErlangAtom "put_chars", ErlangAtom "unicode",
         ErlangAtom "io_lib", ErlangAtom "format",
...
erlps__io_request__2 [pid_0,
  ...
  let
    arg_4 =
      ErlangTuple
        [ErlangAtom "put_chars", ErlangAtom "unicode",
         ErlangAtom "io_lib", ErlangAtom "fwrite",
         ErlangCons format_1 (ErlangCons args_2 ErlangEmptyList)]
  in erlps__bc_req__3 [pid_0, arg_4, ErlangAtom "false"]
erlps__io_request__2 [pid_0, (ErlangAtom "nl")] =
  ...
  in let
    arg_2 =
      ErlangTuple
        [ErlangAtom "put_chars", ErlangAtom "unicode", tup_el_5]
  in erlps__bc_req__3 [pid_0, arg_2, ErlangAtom "false"]
erlps__io_request__2 [_pid_0,
                      request0_3@(ErlangTuple [(ErlangAtom "put_chars"), enc_1,
                                               chars_2])]
  | isEList chars_2 =
  let   
    case_4 =
      EXC.tryCatch
        (\ _ ->
           BIF.do_remote_fun_call "Erlang.Unicode"
             "erlps__characters_to_binary__2" [chars_2, enc_1])
        (\ ex_8 ->
           case ex_8 of
             (ErlangTuple [(ErlangAtom "throw"), payload_10, _]) -> payload_10
             (ErlangTuple [(ErlangAtom "error"), payload_11, stack_12]) ->
               let tup_el_14 = ErlangTuple [payload_11, stack_12]
               in ErlangTuple [ErlangAtom "EXIT", tup_el_14]
             (ErlangTuple [(ErlangAtom "exit"), payload_17, _]) ->
               ErlangTuple [ErlangAtom "EXIT", payload_17]
             ex_9 -> EXC.raise ex_9)
  in let
    request_24 =
      case case_4 of
        binary_20 | isEBinary binary_20 ->
          ErlangTuple [ErlangAtom "put_chars", enc_1, binary_20]
        _ -> request0_3
...
erlps__io_request__2 [pid_0,
  ...
  let
    arg_4 =
      ErlangTuple
        [ErlangAtom "get_until", ErlangAtom "unicode", prompt_1,
         ErlangAtom "io_lib", ErlangAtom "fread",
         ErlangCons format_2 ErlangEmptyList]
  in erlps__bc_req__3 [pid_0, arg_4, ErlangAtom "true"]
erlps__io_request__2 [pid_0,
                      (ErlangTuple [(ErlangAtom "get_until"), enc_1, prompt_2,
                                    m_3, f_4, a_5])]
  =
  let
    arg_7 =
      ErlangTuple
        [ErlangAtom "get_until", enc_1, prompt_2, m_3, f_4, a_5]
  in erlps__bc_req__3 [pid_0, arg_7, ErlangAtom "true"]
erlps__io_request__2 [pid_0,
                      (ErlangTuple [(ErlangAtom "get_chars"), enc_1, prompt_2,
                                    n_3])]
  =
  let
    arg_5 =
...
erlps__io_request__2 args =
  EXC.badarity (ErlangFun 2 erlps__io_request__2) args

erlps__convert_binaries__1 :: ErlangFun
erlps__convert_binaries__1 [bin_0] | isEBinary bin_0 =
  BIF.do_remote_fun_call "Erlang.Unicode"
...
erlps__convert_binaries__1 args =
  EXC.badarity (ErlangFun 1 erlps__convert_binaries__1) args